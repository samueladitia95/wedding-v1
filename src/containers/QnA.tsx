					...
					<div className="flex flex-col gap-10">
						<div className="flex flex-col gap-6">
							...
							<div className="text-sm flex flex-col gap-8 font-medium leading-8 tracking-wide">
								<p>
									Be handsome and beautiful, being ugly is not tolerated (LOL).
									Calling all Ladies! Long dresses are preferred and please wear
									comfortable shoes. Get ready to be dancing all night with
									booze involved.
								</p>
								...
								<p>
									For Gentlemen, suit up. <br /> Kindly leave your batik, jeans,
									t-shirt, slippers at home.
								</p>
							</div>
						</div>
